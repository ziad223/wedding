...
const ServicesSection1 = () => {
  return (
    <div className='flex flex-col xl:flex-row justify-center items-center xl:items-end'>
      <img loading="lazy" src={img1} alt="service-img" className='w-full xl:w-auto mb-5 z-20 xl:mb-0 lg:w-[678px] lg:h-[368px]' />
      <div className='bg-[#f6f2e9] p-5 xl:p-10 xl:-mr-16 xl:-mb-10 xl:mt-5  w-full xl:w-auto'>
