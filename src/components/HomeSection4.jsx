    ...
    <div className='bg-[#f6f2e9] px-4 md:px-8 lg:px-24 py-10'>
      ...
      <Slider {...settings} className="mt-20 ">
        ...
        <img
          src={home3}
          alt="home3"
          className="lg:w-[332px] lg:h-[413px] w-full transition-all duration-200 hover:w-[496px] hover:h-[649px] object-contain"
        />
        ...
        <img
          src={home4}
          alt="home4"
          className="lg:w-[496px] lg:h-[649px] w-full transition-all duration-200 object-contain transform origin-top scale-y-125 object-top"
        />
