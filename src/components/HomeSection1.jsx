    ...
    return (
        <div className="flex flex-col lg:flex-row items-center my-20 px-4 md:px-8 lg:px-24 ">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:mt-14 lg:mr-10 h-full">
                ...
                <Link
                    to="/contact"
                    className="bg-[#907457] py-3 px-6 lg:w-[200px] lg:h-[60px] sm:px-10 text-base sm:text-xl text-white rounded-lg mt-4 hover:bg-[#7c6246] transition-all duration-300 text-center lg:text-right w-[160px] sm:w-[200px] h-[50px] sm:h-[60px] mx-auto lg:mx-0"
                >
                    تواصل معنا
                </Link>
            </div>
