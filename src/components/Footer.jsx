    ...
    return (
        <div className='bg-[#252525] p-10 flex justify-around items-start flex-col lg:gap-0 gap-10 lg:flex-row px-4 md:px-8 lg:px-24'>
            <div className='text-gray-100 lg:w-1/3 w-full text-center'>
                <h2 className='lg:text-2xl text-xl lg:text-right mr-10'>Logo</h2>
                <p className='my-10  lg:text-right'>
            ...
            <div className='text-gray-100 lg:w-1/3 w-full text-center'>
                <h2 className='lg:text-3xl text-xl mb-5'>الرابط</h2>
            ...
            <div className="text-gray-100 lg:w-1/3 w-full ">
                <h2 className='lg:text-2xl text-xl lg:text-right text-center'>احصلى على احدث المعلومات <span className='lg:block'>حول العروض</span></h2>
                <div className="flex items-center border border-gray-300 rounded-md p-2 mt-10">
                ...
                <button className='bg-[#434343] text-gray-100 text-lg hover:bg-[#686666] transition duration-300 rounded-lg p-5 w-full mt-10'>
                    ارسال
                </button>
            </div>
        </div>
