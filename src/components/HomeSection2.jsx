  ...
  return (
      <div className='bg-[#252525] lg:p-10 p-5 relative'>
          ...
          <div className='absolute left-1 hidden lg:block'>
              <img loading="lazy" src={layer} alt="layer" />
          </div>
          <div className='mt-10 relative bg-[#252525] z-20 lg:w-[1128px] lg:h-[532px] lg:mt-20 gap-10 lg:gap-0 border p-10 mx-auto rounded-xl flex flex-wrap justify-between'>
              ...
              <div className='lg:w-1/3 w-full lg:p-4'>
                  <img loading="lazy" src={vector1} alt="vector1" className='mx-auto lg:mx-0 lg:w-[51px] lg:h-[50.91px]' />
              ...
              <div className='lg:w-1/3 w-full lg:p-4'>
                  <img loading="lazy" src={vector2} alt="vector2" className='mx-auto lg:mx-0 lg:w-[57.32px] lg:h-[50.37px]' />
              ...
              <div className='lg:w-1/3 w-full lg:p-4'>
                  <img loading="lazy" src={vector3} alt="vector3" className='mx-auto lg:mx-0 lg:w-[42.37px] lg:h-[56.47px] ' />
              ...
              <div className='lg:w-1/3 w-full lg:p-4 mt-10'>
                  <img loading="lazy" src={vector4} alt="vector4" className='mx-auto lg:mx-0 lg:w-[48.8px] lg:h-[47.28px]' />
              ...
              <div className='lg:w-1/3 w-full lg:p-4 mt-10'>
                  <img loading="lazy" src={vector5} alt="vector5" className='mx-auto lg:mx-0 lg:w-[56px] lg:h-[56px]' />
              ...
              <div className='lg:w-1/3 w-full lg:p-4 mt-10'>
                  <img loading="lazy" src={vector6} alt="vector6" className='mx-auto lg:mx-0 lg:w-[56px] lg:h-[56px]' />
