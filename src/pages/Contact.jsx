...
const Contact = () => {
  return (
    <div className=''>
      ...
      <div className='lg:w-[60%] rounded-lg w-[90%] mx-auto shadow  p-7 relative -top-64 bg-white'>
        <h2 className='border-b-2 text-xl mx-auto text-center w-max'>تواصلي معانا</h2>
        <div className="flex justify-between mt-20 flex-col lg:flex-row">
          ...
          <div className='w-full lg:w-1/2'>
            <div className='flex flex-col lg:items-end gap-6'>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3430.2729567505235!2d31.261422625612912!3d30.710725986698023!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f7c1e092ec4329%3A0x66fa1a7154f19f28!2z2KjZh9in2KEg2KfZhNiv2YrZhtiMINmF2K_ZitmG2Kkg2YXZitiqINi62YXYsSAo2KrYtNmF2YQg2K_Zgtin2K_ZiNizKdiMINmC2LPZhSDZhdmK2Kog2LrZhdix2Iwg2YXYrdin2YHYuNipINin2YTYr9mC2YfZhNmK2Kk!5e0!3m2!1sar!2seg!4v1731278243229!5m2!1sar!2seg" className='h-max'></iframe>
            </div>
